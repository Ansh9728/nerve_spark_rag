...
async def similar_docs(
    ...
    top_k: int = Query(10, ge=1, le=20, description="Number of similar documents to return"),
    rerank_top_n: int = Query(5, ge=1, le=10, description="Number of rerank document to return")
):
...
async def query_with_context(
    ...
    top_k: int = Query(10, ge=1, le=15, description="Number of context documents to use"),
